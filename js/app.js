class UI {
  ...
  submitBudgetForm() {
    ...
    if (value === "" || value < 0) {
      ...
      const self = this; //herre this points to global ui
      setTimeout(function () {
        self.budgetFeedback.classList.remove("showItem"); //here this will point to submitBudgetForm func
      }, 2000);
    } else {
